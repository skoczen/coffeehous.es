...
env.app_string = ""
env.DEV_DB_URL = "postgres://@localhost:5432/coffeehouses"

env.SERVERS = {
    "live": "coffeehouses",
    "staging": "coffeehouses-staging",
}
...
def setup_db():
    local_venv("dropdb coffeehouses --if-exists -U skoczen")
    local_venv("createdb coffeehouses -U skoczen")
